    ...
    try {
      ...
      if (res.data.success) {
        ...
        const adminRoutes = res.data.routes.filter(
          (route) => route.moduleId?.moduleName === "Admin"
        );
    ...
    <>
      <div className="p-6 max-w-6xl mx-auto text-white bg-gray-600 rounded-2xl">
        <div className=" flex justify-between items-center">
          <h1 className="text-2xl font-semibold mb-5 text-left">Admin Menus</h1>
          <NavLink
            to="/"
            ...
            {routes.map((route) => (
              <>
                <div
                  ...
                  className="bg-gray-900 cursor-pointer transition-all duration-700 hover:ring-1 text-white shadow-2xs rounded-2xl p-5 hover:shadow-xl "
                >
